...
const defaultValues: Values = { name: '', email: '', password: '', terms: false };
  ...
  const onSubmit = React.useCallback(
    async (values: Values): Promise<void> => {
      ...
      try {
        ...
        setError('root', {
          type: 'server',
          message: error.response?.data || 'Something went wrong during registration'
        });
      } finally {
        setIsPending(false);
      }
            ...
            render={({ field }) => (
              <div>
                <FormControlLabel
                  ...
                  label={
                    <React.Fragment>
                      I have read the <Link href="/terms">terms and conditions</Link>
                    </React.Fragment>
                  }
                />
